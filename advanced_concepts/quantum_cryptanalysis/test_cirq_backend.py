...
from cirq_backend import grover_search, optimal_iterations
...
class TestGroverSearch(unittest.TestCase):
    ...
    def test_finds_marked_item_with_high_probability(self):
        for num_qubits in (2, 3, 4, 5):
            marked = 3
            result = grover_search(num_qubits, marked_index=marked, repetitions=1000)
    ...
    def test_two_qubit_case_is_near_certain(self):
        result = grover_search(2, marked_index=3, repetitions=2000)
